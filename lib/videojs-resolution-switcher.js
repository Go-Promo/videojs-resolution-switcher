...
(function() {
  ...
  (function(window, videojs) {
    ...
    function setSourcesSanitizedCallback(player, currentTime, isPaused) {
  ...
  var ResolutionMenuItem = videojs.extend(MenuItem, {
    ...
    onClick: function(customSourcePicker) {
      ...
      setSourcesSanitized(this.player_, this.src, this.options_.label, customSourcePicker).one(handleSeekEvent, function() {
        // on Android currentTime must be set after `durationchange` event
        if (!this.player_.hls && /Android/.test(window.navigator.userAgent)) {
          this.player_.one('durationchange', function() {
            setSourcesSanitizedCallback(this.player_, currentTime, isPaused);
            handlingClick = false;
          });
        } else {
          setSourcesSanitizedCallback(this.player_, currentTime, isPaused);
